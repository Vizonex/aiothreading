...
@pytest.mark.asyncio
async def test_pool(thread_pool_type:Callable[..., ThreadPool]):
...
@pytest.mark.asyncio
async def test_pool_map(thread_pool_type:Callable[..., ThreadPool]):
...
if not SKIP_ASYNC_TIMEOUT:
    @pytest.mark.asyncio
    async def test_pool_can_execute_quick_enough(thread_pool_type: Callable[..., ThreadPool]):
